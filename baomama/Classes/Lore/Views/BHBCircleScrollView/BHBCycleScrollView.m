...
#define kPageControllHeight 50

#import "BHBCycleScrollView.h"
#import "NSTimer+Addition.h"

@interface BHBCycleScrollView () <UIScrollViewDelegate>
...
@implementation BHBCycleScrollView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
       ...
       _pageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(0, self.frame.size.height - kPageControllHeight, self.frame.size.width, kPageControllHeight)];
